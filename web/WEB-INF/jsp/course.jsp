    ...
    function reload(){
        layui.use('table', function(){
            ...
            table.render({
                elem: '#demo'
                ,height: 523
                ,url: '/student/empDataList' //数据接口
                ,toolbar: '#toolbarDemo' //开启头部工具栏，并为其绑定左侧模板
                ,page: true //开启分页
                ,cols: [[ //表头
                    {field: 'empId', title: '序号', width:100, sort: true, fixed: 'left'}
                    ,{field: 'empName', title: '课程名称'}
                    ,{field: 'depName', title: '是否必修'}
                    ,{field: 'depName', title: '课程类别'}
                    ,{field: 'depName', title: '说明'}
