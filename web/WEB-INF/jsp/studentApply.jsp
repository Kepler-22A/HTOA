...
<%--           学生请假的form表单            --%>
<form id="stuApplyForm" action="${pageContext.request.contextPath}/leave/addStuApply" method="post" style="display: none" class="layui-form">
...
<script>
    ...
    layui.use(['layer', 'jquery', 'form'], function() {
        ...
        form.on('submit(applyForm)', function(){
            $.ajax({
                url: "${pageContext.request.contextPath}/leave/addStuApply"
                ,type: "post"
                ,data:$("#stuApplyForm").serialize()
                ,async:false
                ,success:function () {
