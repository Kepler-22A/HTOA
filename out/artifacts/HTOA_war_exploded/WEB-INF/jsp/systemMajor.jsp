...
<div class="layui-form">
    ...
    <script>
        layui.use('table', function(){
            ...
            table.render({
                elem: '#Table'
                ,url:'/system/majordata'
                ,toolbar: '#toolbarDemo'
                ,height:400
                ,cols: [[
                    {field:'majorID', width:100, title: '编号', sort: true}
                    ,{field:'majorName', width:250, title: '专业名称', sort: true}
...
<form  class="layui-form" id="addfloor" style="display: none" method="post" action="${pageContext.request.contextPath}/system/addMajor">
